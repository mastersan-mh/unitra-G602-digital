    ...
    m_ui(new SettingsDialog_Ui)
{
    ...
    connect(m_ui->baudRateBox, SIGNAL(currentIndexChanged(int)),
...
void SettingsDialog::showPortInfo(int idx)
{
    ...
    QStringList list = m_ui->serialPortInfoListBox->itemData(idx).toStringList();
...
void SettingsDialog::updateSettings()
{
    ...
    currentSettings.localEchoEnabled = m_ui->localEchoCheckBox->isChecked();
}
